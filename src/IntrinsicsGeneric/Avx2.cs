...
namespace IntrinsicsGeneric
{
        ...
        where T : unmanaged
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static Vector256<T> And(Vector256<T> va, Vector256<T> vb)
        {
            if (typeof(T) == typeof(sbyte))
            {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe Vector256<T> LoadVector256(T* address)
        {
            if (typeof(T) == typeof(sbyte))
            {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe void Store(T* address, Vector256<T> vector256)
        {
            if (typeof(T) == typeof(sbyte))
            {
